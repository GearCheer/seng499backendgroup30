...
# CONSTANTS
DATASET_PATH = "reclassified-dataset-small" # Path to datset from working directory.
...
class Classifier:
    ...
    def _train_new_model(self, imageset_path):
        ...
        self.model.fit_generator(train_it, epochs=5, steps_per_epoch=BATCH_SIZE, verbose=1)
